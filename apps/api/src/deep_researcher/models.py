...
class ResearchPlan(Base):
    ...
    trigger_ref: Mapped[str | None] = mapped_column(String(500), default=None)
    decision_ref: Mapped[str | None] = mapped_column(String(500), default=None)
    inherited_task_ordinals: Mapped[list[int]] = mapped_column(JSON, default=list)
    replaced_task_ordinals: Mapped[list[int]] = mapped_column(JSON, default=list)
